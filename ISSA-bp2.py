...
def main():
    ...
    Curve1, Curve2, Curve3 = train(net, epochs=500, x_train=x_train_normalized, y_train=y_train_normalized, x_test = x_test_normalized, y_test = y_test_normalized)
